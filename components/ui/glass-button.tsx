...
> = {
  default: {
    bgTop: "rgba(255,255,255,0.09)",
    bgBottom: "rgba(255,255,255,0.03)",
    border: "rgba(255,255,255,0.3)",
    borderBottom: "rgba(255,255,255,0.09)",
    glow: "radial-gradient(ellipse at center, rgba(255,255,255,0.12) 0%, transparent 70%)",
    glowBlur: "blur(14px)",
    shimmer: "rgba(255,255,255,0.18)",
  },
  accent: {
    bgTop: "rgba(116, 214, 255, 0.12)",
    bgBottom: "rgba(98, 132, 255, 0.03)",
    border: "rgba(156, 227, 255, 0.34)",
    borderBottom: "rgba(112, 154, 255, 0.12)",
    glow: "radial-gradient(ellipse at center, rgba(74, 222, 255, 0.22) 0%, transparent 72%)",
    glowBlur: "blur(16px)",
    shimmer: "rgba(214,240,255,0.22)",
  },
  ghost: {
